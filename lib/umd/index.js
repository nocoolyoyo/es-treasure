(function (global, factory) {
	if (typeof define === "function" && define.amd) {
		define(['module', './copy2Board', './device', './is', './getParam', './getStyle', './imageLoaded', './regexMap', './strStyle'], factory);
	} else if (typeof exports !== "undefined") {
		factory(module, require('./copy2Board'), require('./device'), require('./is'), require('./getParam'), require('./getStyle'), require('./imageLoaded'), require('./regexMap'), require('./strStyle'));
	} else {
		var mod = {
			exports: {}
		};
		factory(mod, global.copy2Board, global.device, global.is, global.getParam, global.getStyle, global.imageLoaded, global.regexMap, global.strStyle);
		global.index = mod.exports;
	}
})(this, function (module, _copy2Board, _device, _is, _getParam, _getStyle, _imageLoaded, _regexMap, _strStyle) {
	'use strict';
