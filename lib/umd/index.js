(function (global, factory) {
	if (typeof define === "function" && define.amd) {
		define(['module', './copy2Board', './device', './validate', './styleUtils', './getParam', './imageLoaded', './regexMap'], factory);
	} else if (typeof exports !== "undefined") {
		factory(module, require('./copy2Board'), require('./device'), require('./validate'), require('./styleUtils'), require('./getParam'), require('./imageLoaded'), require('./regexMap'));
	} else {
		var mod = {
			exports: {}
		};
		factory(mod, global.copy2Board, global.device, global.validate, global.styleUtils, global.getParam, global.imageLoaded, global.regexMap);
		global.index = mod.exports;
	}
})(this, function (module, _copy2Board, _device, _validate, _styleUtils, _getParam, _imageLoaded, _regexMap) {
	'use strict';
